...
export default function LocationContact() {
  ...
  const whatsappHref = waLink(
    BRAND.phoneE164,
    `Hi ${BRAND.name}, I want details for ${active.name} (${active.area}).`
  );
    ...
    >
      ...
      <Container>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          {/* RIGHT — active branch detail + form */}
            ...
            >
              ...
              <div className="relative h-64 md:h-72">
                <Image
                  ...
                  alt={`${active.name} interior in ${active.area}`}
                  fill
              ...
              <div className="grid gap-6 p-6 md:p-8 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="mt-6 grid gap-3">
                    {active.timings.slice(0, 2).map((t) => (
                      <div
                        key={t}
                    ...
                    <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-white/40">
                      {active.timings[2]} · {active.timings[3]}
                    </p>
                  </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                  ...
                  <p className="mt-1 text-xs text-white/55">
                    For {active.area}, our team will reach out within working hours.
                  </p>
